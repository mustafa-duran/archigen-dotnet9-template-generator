...
using static Project.Application.Features.Authentication.Constants.AuthenticationOperationClaims;

namespace Project.Application.Features.Authentication.Commands.RevokeToken;
...
public class RevokeTokenCommand : IRequest<RevokedTokenResponse>, ISecuredRequest
{
    ...
    public string[] Roles => [Admin, AuthenticationOperationClaims.RevokeToken];
    ...
    public class RevokeTokenCommandHandler : IRequestHandler<RevokeTokenCommand, RevokedTokenResponse>
    {
        ...
        public RevokeTokenCommandHandler(IAuthService authService, AuthenticationBusinessRules authBusinessRules, IMapper mapper)
        {
