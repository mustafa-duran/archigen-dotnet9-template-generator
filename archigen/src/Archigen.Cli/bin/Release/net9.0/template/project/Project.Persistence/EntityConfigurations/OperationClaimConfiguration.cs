...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = AuthenticationOperationClaims.Admin },
                new() { Id = ++lastId, Name = AuthenticationOperationClaims.Read },
                new() { Id = ++lastId, Name = AuthenticationOperationClaims.Write },
                new() { Id = ++lastId, Name = AuthenticationOperationClaims.RevokeToken },
            ]
        );
        #endregion
